...
for peak in range(100,10000,500):
    ...
    visualizer = ClassificationReport(poly, classes=label, support=True)
    ...
    # scores_1 = cross_val_score(rbf, X, Y, scoring='accuracy', cv=4)
    # print(scores_1)
    # print(f"for svm with polynomial kernel kernel")
    # scores_2 = cross_val_score(rbf, X, Y, scoring='accuracy', cv=4)
    # print(scores_2)